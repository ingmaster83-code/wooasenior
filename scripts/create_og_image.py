...
# 색상 (우아경로당 테마 - 바이올렛/퍼플)
BG        = (245, 243, 255)   # #F5F3FF  violet-50
ACCENT    = (109, 40,  217)   # #6D28D9  primary
ACCENT2   = (124, 58,  237)   # #7C3AED  accent
...
def create_og_image():
    ...
    draw.ellipse([820, -120, 1380, 440], fill=(221, 214, 254))   # violet-200
    draw.ellipse([900, 340, 1300, 740], fill=(196, 181, 253))    # violet-300

    draw_rounded_rect(draw, (60, 60, 72, 570), 6, ACCENT)

    badge_font = load_font(22, bold=True)
    badge_text = "지자체 공공데이터"
    ...
    draw.text((100, 390), "이름·지역으로 바로 찾는 전국 경로당 정보", fill=GRAY, font=sub_font)
    ...
    draw.text((100, 550), "wooasenior.wooahouse.com", fill=ACCENT, font=domain_font)
